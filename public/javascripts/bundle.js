	        ...
	        value: function render() {
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(_chat2.default, { channel: 'la', token: this.state.token, username: this.state.user })
	                )
	            );
	        }
	    }]);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var ChatFrame = function (_Component) {
	    ...
	    function ChatFrame(props) {
	        ...
	        var _this = _possibleConstructorReturn(this, (ChatFrame.__proto__ || Object.getPrototypeOf(ChatFrame)).call(this, props));
	        ...
	        _this.loadTwiliochat();
	        return _this;
	    }

	    _createClass(ChatFrame, [{
	        key: 'loadTwiliochat',
	        value: function loadTwiliochat() {

	            // Our interface to the Chat service
	            var chatClient = void 0;

	            // A handle to the state chat channel
	            var generalChannel = this.state.channel;
	            ...
	            function loadFrame(client, channel) {
	                ...
	                var frameConfiguration = {
	                    channel: {
	                        chrome: {
	                            closeCallback: function closeCallback(channelSid) {
	                                alert('close');
	        ...
	        key: 'render',
	        value: function render() {
	            return _react2.default.createElement('div', { id: 'chatContainer', className: 'twilio-react-chat' });
	        }
	    }]);
